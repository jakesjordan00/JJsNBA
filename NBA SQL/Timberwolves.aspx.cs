...
namespace NBA_SQL
{
    public partial class Timberwolves : System.Web.UI.Page
    {
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdTimberwolves.Visible = true;
            grdTimberwolvesSeason.Visible = false;
            grdTimberwolvesPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdTimberwolves.Visible = false;
            grdTimberwolvesSeason.Visible = true;
            grdTimberwolvesPerMin.Visible = false; grdW.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdTimberwolves.Visible = false;
            grdTimberwolvesSeason.Visible = false;
            grdTimberwolvesPerMin.Visible = true;
            grdW.Visible = false;
        }
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdTimberwolves.Visible = false;
            grdTimberwolvesSeason.Visible = false;
            grdTimberwolvesPerMin.Visible = false;
            grdW.Visible = true;
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#0c2340"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#0c2340"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#0c2340"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#0c2340"); Button1.ForeColor = System.Drawing.Color.White;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdTimberwolves.DataSource = dataT;
                            grdTimberwolves.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdTimberwolvesSeason.DataSource = dataT;
                            grdTimberwolvesSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdTimberwolvesPerMin.DataSource = dataT;
                            grdTimberwolvesPerMin.DataBind();
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                string teamLink = "";
                                string hex = "#0c2340"; //Blue
                                string hex1 = "#78be20"; //Green
                                string white = "white";
                                if (matchup == blazers)
                                {
        ...
        protected void grdTimberwolves_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdTimberwolves.DataSource = sortedView;
                            grdTimberwolves.DataBind();
                        }
                    }
                }
        ...
        protected void grdTimberwolvesSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdTimberwolvesSeason.DataSource = sortedView;
                            grdTimberwolvesSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdTimberwolvesPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdTimberwolvesPerMin.DataSource = sortedView;
                            grdTimberwolvesPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Timberwolves"))
                {
                    querySearch.Connection = sqlConnect;
