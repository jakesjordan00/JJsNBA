...
namespace NBA_SQL
{
    public partial class Clippers : System.Web.UI.Page
    {
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#1d428a"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#1d428a"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#1d428a"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#1d428a"); Button1.ForeColor = System.Drawing.Color.White;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindGrid();
                grdClippers.Visible = true;
                grdClippersSeason.Visible = false;
                grdClippersPerMin.Visible = false;
                grdW.Visible = false;
                PopulateRoster();
                GridView1.Visible = false;
                GridView2.Visible = false;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdClippers.DataSource = dataT;
                            grdClippers.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdClippersSeason.DataSource = dataT;
                            grdClippersSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdClippersPerMin.DataSource = dataT;
                            grdClippersPerMin.DataBind();
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                string teamLink = "";
                                string hex = "#1d428a"; //blue
                                string hex1 = "#bec0c2"; //grey
                                string white = "white";
                                if (matchup == blazers)
                                {
                                    ...
                                    else //alternating row
                                    {
                                        ...
                                        row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#1d428a; \" >" +  teamLink1 + "</a>";
                                    }
                                }
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                        row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(white);
                                        row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#1d428a; \" >" +  team1 + "</a>";
                                    }
                                }
                            }
                        }
        ...
        {
            grdClippers.Visible = true;
            grdClippersSeason.Visible = false; grdW.Visible = false;
            grdClippersPerMin.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdClippers.Visible = false;
            grdClippersSeason.Visible = true; grdW.Visible = false;
            grdClippersPerMin.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdClippers.Visible = false;
            grdClippersSeason.Visible = false; grdW.Visible = false;
            grdClippersPerMin.Visible = true;
        }
        ...
        protected void grdClippers_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdClippers.DataSource = sortedView;
                            grdClippers.DataBind();
                        }
                    }
                }
        ...
        protected void grdClippersSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdClippersSeason.DataSource = sortedView;
                            grdClippersSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdClippersPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdClippersPerMin.DataSource = sortedView;
                            grdClippersPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Clippers"))
                {
                    querySearch.Connection = sqlConnect;
