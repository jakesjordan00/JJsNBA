...
namespace NBA_SQL
{
    public partial class Pistons : System.Web.UI.Page
    {
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdPistons.Visible = true;
            grdPistonsSeason.Visible = false;
            grdPistonsPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdPistons.Visible = false;
            grdPistonsSeason.Visible = true;
            grdPistonsPerMin.Visible = false; grdW.Visible = false;
        }
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdPistons.Visible = false;
            grdPistonsSeason.Visible = false;
            grdPistonsPerMin.Visible = false;
            grdW.Visible = true;
        }
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdPistonsSeason.DataSource = dataT;
                            grdPistonsSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdPistonsPerMin.DataSource = dataT;
                            grdPistonsPerMin.DataBind();
        ...
        protected void grdPistons_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdPistons.DataSource = sortedView;
                            grdPistons.DataBind();
                        }
                    }
                }
        ...
        protected void grdPistonsSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdPistonsSeason.DataSource = sortedView;
                            grdPistonsSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdPistonsPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdPistonsPerMin.DataSource = sortedView;
                            grdPistonsPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Pistons"))
                {
                    querySearch.Connection = sqlConnect;
