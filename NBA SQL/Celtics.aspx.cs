...
namespace NBA_SQL
{
    public partial class Celtics : System.Web.UI.Page
    {
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#007a33"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#007a33"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#007a33"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#007a33"); Button1.ForeColor = System.Drawing.Color.White;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindGrid();
                grdCeltics.Visible = true;
                grdCelticsSeason.Visible = false;
                grdCelticsPerMin.Visible = false;
                grdW.Visible = false;
                PopulateRoster();
                GridView1.Visible = false;
                GridView2.Visible = false;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdCelticsSeason.DataSource = dataT;
                            grdCelticsSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdCelticsPerMin.DataSource = dataT;
                            grdCelticsPerMin.DataBind();
                        ...
                        using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                        {
                            ...
                            using (DataTable dataT = new DataTable())
                            {
                                ...
                                foreach (GridViewRow row in grdPlayerGames.Rows)
                                {
                                    ...
                                    string teamLink = "";
                                    string hex = "#007a33"; //green
                                    string hex1 = "White"; //white
                                    string white = "white";
                                    if (matchup == blazers)
                                    {
                                        ...
                                        else //alternating row
                                        {
                                            ...
                                            row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#007a33; \" >" + teamLink1 + "</a>";
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                            row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(white);
                                            row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#007a33; \" >" + team1 + "</a>";
                                        }
                                    }
                                }
                            }
        ...
        {
            grdCeltics.Visible = true;
            grdCelticsSeason.Visible = false; grdW.Visible = false;
            grdCelticsPerMin.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdCeltics.Visible = false;
            grdCelticsSeason.Visible = true; grdW.Visible = false;
            grdCelticsPerMin.Visible = false;
        }
        ...
        protected void grdCeltics_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdCeltics.DataSource = sortedView;
                            grdCeltics.DataBind();
                        }
                    }
                }
        ...
        protected void grdCelticsSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdCelticsSeason.DataSource = sortedView;
                            grdCelticsSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdCelticsPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdCelticsPerMin.DataSource = sortedView;
                            grdCelticsPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Celtics"))
                {
                    querySearch.Connection = sqlConnect;
