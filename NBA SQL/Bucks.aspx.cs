...
namespace NBA_SQL
{
    public partial class Bucks : System.Web.UI.Page
    {
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdBucks.Visible = true;
            grdBucksSeason.Visible = false;
            grdBucksPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdBucks.Visible = false;
            grdBucksSeason.Visible = true;
            grdBucksPerMin.Visible = false; grdW.Visible = false;
        }
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdBucks.Visible = false;
            grdBucksSeason.Visible = false;
            grdBucksPerMin.Visible = false;
            grdW.Visible = true;
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#0077c0"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#0077c0"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#0077c0"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#0077c0"); Button1.ForeColor = System.Drawing.Color.White;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdBucksSeason.DataSource = dataT;
                            grdBucksSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdBucksPerMin.DataSource = dataT;
                            grdBucksPerMin.DataBind();
                        ...
                        using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                        {
                            ...
                            using (DataTable dataT = new DataTable())
                            {
                                ...
                                foreach (GridViewRow row in grdPlayerGames.Rows)
                                {
                                    ...
                                    string teamLink = "";
                                    string hex = "#00471b"; //cream
                                    string hex1 = "#eee1c6"; //green
                                    string white = "white";
                                    if (matchup == blazers)
                                    {
                                        ...
                                        if (i % 2 == 0) //row
                                        {
                                            ...
                                            row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#eee1c6;\" >" + teamLink1 + "</a>";
                                        }
                                        else //alternating row
                                        {
                                            ...
                                            row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#00471b; \" >" + teamLink1 + "</a>";
                                        }
                                    }
                                    else
                                    {
                                        if (i % 2 == 0)
                                        {
                                            ...
                                            row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex);
                                            row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(white);
                                            row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#eee1c6; \" >" + team1 + "</a>";
                                        ...
                                        else
                                        {
                                            ...
                                            row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                            row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(white);
                                            row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#00471b; \" >" + team1 + "</a>";
                                        }
                                    }
                                }
                            }
        ...
        protected void BtnPlayerWins_Click(object sender, EventArgs e)
        {
                    ...
                    using (SqlCommand querySearch = new SqlCommand("seasonbox_playersinwin"))
                    {
                        ...
                        using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                        {
                            ...
                            using (DataTable dataT = new DataTable())
                            {
                                ...
                                foreach (GridViewRow row in grdPlayerGames.Rows) { row.Cells[2].Text = row.Cells[2].Text.Split(' ')[0]; }
                                grdPlayerWins.Visible = true;
                                int i = 1;
            ...
            protected void grdBucks_Sorting(object sender, GridViewSortEventArgs e)
            {
                SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
                using (sqlConnect)
                {
                    ...
                    using (SqlCommand querySearch = new SqlCommand("roster"))
                    {
                        ...
                        using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                        {
                            ...
                            using (DataTable dataT = new DataTable())
                            {
                                ...
                                grdBucks.DataSource = sortedView;
                                grdBucks.DataBind();
                            }
                        }
                    }
        ...
        protected void grdBucksSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdBucksSeason.DataSource = sortedView;
                            grdBucksSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdBucksPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdBucksPerMin.DataSource = sortedView;
                            grdBucksPerMin.DataBind();
                        }
                    }
                }
                        ...
                        {
                            {
                                ...
                                grdPlayerWins.DataBind();foreach (GridViewRow row in grdPlayerGames.Rows) { row.Cells[2].Text = row.Cells[2].Text.Split(' ')[0]; }
                                int i = 1;
                                foreach (GridViewRow row in grdPlayerWins.Rows)
                                {
                                    if (row.Cells[1].Text != team)
                ...
                using (SqlCommand querySearch = new SqlCommand("seasonbox_playergames"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdPlayerGames.DataBind(); foreach (GridViewRow row in grdPlayerGames.Rows) { row.Cells[2].Text = row.Cells[2].Text.Split(' ')[0]; } foreach (GridViewRow row in grdPlayerGames.Rows) { row.Cells[2].Text = row.Cells[2].Text.Split(' ')[0]; }
                            int i = 1;
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                if (row.Cells[1].Text != team)
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Bucks"))
                {
                    querySearch.Connection = sqlConnect;
