...
namespace NBA_SQL
{
    public partial class Kings : System.Web.UI.Page
    {
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdKings.Visible = true;
            grdKingsSeason.Visible = false;
            grdKingsPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdKings.Visible = false;
            grdKingsSeason.Visible = true;
            grdKingsPerMin.Visible = false; grdW.Visible = false;
        }
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdKings.Visible = false;
            grdKingsSeason.Visible = false;
            grdKingsPerMin.Visible = false;
            grdW.Visible = true;
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#5a2d81"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#5a2d81"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#5a2d81"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#5a2d81"); Button1.ForeColor = System.Drawing.Color.White;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdKingsSeason.DataSource = dataT;
                            grdKingsSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdKingsPerMin.DataSource = dataT;
                            grdKingsPerMin.DataBind();
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                string teamLink = "";
                                string hex = "#5a2d81"; //Purple
                                string hex1 = "#63727a"; //Grey
                                string white = "white";
                                if (matchup == blazers)
                                {
        ...
        protected void grdKings_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdKings.DataSource = sortedView;
                            grdKings.DataBind();
                        }
                    }
                }
        ...
        protected void grdKingsSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdKingsSeason.DataSource = sortedView;
                            grdKingsSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdKingsPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdKingsPerMin.DataSource = sortedView;
                            grdKingsPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Kings"))
                {
                    querySearch.Connection = sqlConnect;
