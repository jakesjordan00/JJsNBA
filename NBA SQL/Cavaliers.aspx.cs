...
namespace NBA_SQL
{
    public partial class Cavaliers : System.Web.UI.Page
    {
        string yella = "#fdbb30";
        protected void Button1_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.Color.LightCyan; Button1.ForeColor = System.Drawing.Color.Black;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#041e42"); Button2.ForeColor = System.Drawing.ColorTranslator.FromHtml("#fdbb30");
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#041e42"); Button3.ForeColor = System.Drawing.ColorTranslator.FromHtml("#fdbb30");
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#041e42"); Button4.ForeColor = System.Drawing.ColorTranslator.FromHtml("#fdbb30");
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#041e42"); Button1.ForeColor = System.Drawing.ColorTranslator.FromHtml("#fdbb30");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindGrid();
                grdCavaliers.Visible = true;
                grdCavaliersSeason.Visible = false;
                grdCavaliersPerMin.Visible = false;
                grdW.Visible = false;
                PopulateRoster();
                GridView1.Visible = false;
                GridView2.Visible = false;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdCavaliers.DataSource = dataT;
                            grdCavaliers.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdCavaliersSeason.DataSource = dataT;
                            grdCavaliersSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdCavaliersPerMin.DataSource = dataT;
                            grdCavaliersPerMin.DataBind();
        ...
        protected void BtnPlayerGames_Click(object sender, EventArgs e) {if (chkRoster.SelectedValue == "") { lblPGError.Text = "Please select a player"; return; }
            else
            {
                lblPGError.Text = "";
                        ...
                        using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                        {
                            ...
                            using (DataTable dataT = new DataTable())
                            {
                                ...
                                foreach (GridViewRow row in grdPlayerGames.Rows)
                                {
                                    ...
                                    {
                                        row.Cells[1].ForeColor = System.Drawing.ColorTranslator.FromHtml(yella);
                                    }
                                    i++;
                                    ...
                                    string teamLink = "";
                                    string hex = "#041e42"; //blue
                                    string hex1 = "#860038"; //red
                                    string white = "white";
                                    if (matchup == blazers)
                                    {
        ...
        {
            grdCavaliers.Visible = true; grdW.Visible = false;
            grdCavaliersSeason.Visible = false;
            grdCavaliersPerMin.Visible = false;
        }
        ...
        {
            grdCavaliers.Visible = false;
            grdCavaliersSeason.Visible = true; grdW.Visible = false;
            grdCavaliersPerMin.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdCavaliers.Visible = false;
            grdCavaliersSeason.Visible = false; grdW.Visible = false;
            grdCavaliersPerMin.Visible = true;
        }
        ...
        protected void grdCavaliers_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdCavaliers.DataSource = sortedView;
                            grdCavaliers.DataBind();
                        }
                    }
                }
        ...
        protected void grdCavaliersSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdCavaliersSeason.DataSource = sortedView;
                            grdCavaliersSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdCavaliersPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdCavaliersPerMin.DataSource = sortedView;
                            grdCavaliersPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Cavaliers"))
                {
                    querySearch.Connection = sqlConnect;
