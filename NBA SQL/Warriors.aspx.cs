...
namespace NBA_SQL
{
    public partial class Warriors : System.Web.UI.Page
    {
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdWarriors.Visible = true;
            grdWarriorsSeason.Visible = false;
            grdWarriorsPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdWarriors.Visible = false;
            grdWarriorsSeason.Visible = true;
            grdWarriorsPerMin.Visible = false; grdW.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdWarriors.Visible = false;
            grdWarriorsSeason.Visible = false;
            grdWarriorsPerMin.Visible = true;
            grdW.Visible = false;
        }
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdWarriors.Visible = false;
            grdWarriorsSeason.Visible = false;
            grdWarriorsPerMin.Visible = false;
            grdW.Visible = true;
        }
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdWarriorsSeason.DataSource = dataT;
                            grdWarriorsSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdWarriorsPerMin.DataSource = dataT;
                            grdWarriorsPerMin.DataBind();
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                string teamLink = "";
                                string hex = "#006bb6"; //Blue
                                string hex1 = "#fdb927"; //Yellow
                                string white = "white";
                                if (matchup == blazers)
                                {
                                    ...
                                    else //alternating row
                                    {
                                        ...
                                        row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#006bb6; \" >" +  teamLink1 + "</a>";
                                    }
                                }
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                        row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(white);
                                        row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#006bb6; \" >" +  team1 + "</a>";
                                    }
                                }
                            }
                        }
        ...
        protected void grdWarriors_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdWarriors.DataSource = sortedView;
                            grdWarriors.DataBind();
                        }
                    }
                }
        ...
        protected void grdWarriorsSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdWarriorsSeason.DataSource = sortedView;
                            grdWarriorsSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdWarriorsPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdWarriorsPerMin.DataSource = sortedView;
                            grdWarriorsPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Warriors"))
                {
                    querySearch.Connection = sqlConnect;
