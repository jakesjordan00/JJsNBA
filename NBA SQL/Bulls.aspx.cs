...
namespace NBA_SQL
{
    public partial class Bulls : System.Web.UI.Page
    {
        ...
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button1.ForeColor = System.Drawing.Color.White;
            Button2.BackColor = System.Drawing.Color.White; Button2.ForeColor = System.Drawing.Color.Black;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button4.ForeColor = System.Drawing.Color.White;
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            Button1.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button1.ForeColor = System.Drawing.Color.White;
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.Color.White; Button3.ForeColor = System.Drawing.Color.Black;
            Button4.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button4.ForeColor = System.Drawing.Color.White;
            GridView1.Visible = false;
            GridView2.Visible = false;
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            Button2.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button2.ForeColor = System.Drawing.Color.White;
            Button3.BackColor = System.Drawing.ColorTranslator.FromHtml("#000000"); Button3.ForeColor = System.Drawing.Color.White;
            Button4.BackColor = System.Drawing.Color.White; Button4.ForeColor = System.Drawing.Color.Black;
            GridView1.Visible = false;
            GridView2.Visible = false;
            GridView3.Visible = false;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindGrid();
                grdBulls.Visible = true;
                grdBullsSeason.Visible = false;
                grdBullsPerMin.Visible = false;
                grdW.Visible = false;
                PopulateRoster();
                GridView1.Visible = false;
                GridView2.Visible = false;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdBullsSeason.DataSource = dataT;
                            grdBullsSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdBullsPerMin.DataSource = dataT;
                            grdBullsPerMin.DataBind();
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                string teamLink = "";
                                string hex = "#ce1141"; //cream
                                string hex1 = "Black"; //green
                                string white = "white";
                                if (matchup == blazers)
                                {
        ...
        protected void BtnPG_Click(object sender, EventArgs e)
        {
            grdBulls.Visible = true;
            grdBullsSeason.Visible = false;
            grdBullsPerMin.Visible = false; grdW.Visible = false;
        }

        protected void BtnSeason_Click(object sender, EventArgs e)
        {
            grdBulls.Visible = false;
            grdBullsSeason.Visible = true;
            grdBullsPerMin.Visible = false; grdW.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdBulls.Visible = false;
            grdBullsSeason.Visible = false;
            grdBullsPerMin.Visible = true; grdW.Visible = false;
        }
        ...
        protected void grdBulls_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdBulls.DataSource = sortedView;
                            grdBulls.DataBind();
                        }
                    }
                }
        ...
        protected void grdBullsSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdBullsSeason.DataSource = sortedView;
                            grdBullsSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdBullsPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdBullsPerMin.DataSource = sortedView;
                            grdBullsPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Bulls"))
                {
                    querySearch.Connection = sqlConnect;
