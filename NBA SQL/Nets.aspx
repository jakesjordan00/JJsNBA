<%@ Page MaintainScrollPositionOnPostback="true" Title="Nets" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Nets.aspx.cs" Inherits="NBA_SQL.Nets" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="body_content">
    <style>
        body {background-color: Black}
    </style>
    <h1 style="color:grey"><asp:Image ID="Image1" Width="100px" Height="100px" runat="server" src="Nets-logo.png"/>(BKN)Brooklyn Nets</h1>
<%-- TO BE COPIED TO ALL OTHER TEAMS --%>
   ...
   <br />
    <asp:Button class="btn btn-primary active" ID="btnPG" runat="server" Text="Per Game Statistics" OnClick="BtnPG_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="btnW" runat="server" Text="Per Game in Win" OnClick="btnW_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="btnSeason" runat="server" Text="Season Statistics" OnClick="BtnSeason_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="btnPM" runat="server" Text="Per Minute Statistics" OnClick="BtnPM_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:GridView ID="grdNetsPerMin" runat="server" DataKeyNames="Roster" AllowSorting="true" CssClass="RosterTable"  Width="1300px" Height="350px" OnSorting="grdNetsPerMin_Sorting" 
                  AlternatingRowStyle-BackColor="#777d84" RowStyle-BackColor="#000000" RowStyle-ForeColor="White" AlternatingRowStyle-ForeColor="White" HeaderStyle-ForeColor="White"
                                                                                                                                                   HeaderStyle-BorderColor="Black"
                                                                                                                                                   RowStyle-BorderColor="#000000"                                                                                                                                         
                                                                                                                                                   AlternatingRowStyle-BorderColor="#777d84">
    </asp:GridView>

    <asp:GridView ID="grdNetsSeason" runat="server" DataKeyNames="Roster" AllowSorting="true" CssClass="RosterTable"  Width="1300px" Height="350px" OnSorting="grdNetsSeason_Sorting"
                  AlternatingRowStyle-BackColor="#777d84" RowStyle-BackColor="#000000" RowStyle-ForeColor="White" AlternatingRowStyle-ForeColor="White" HeaderStyle-ForeColor="White"
                                                                                                                                                   HeaderStyle-BorderColor="Black"
                                                                                                                                                   RowStyle-BorderColor="#000000"                                                                                                                                         
                                                                                                                                                   AlternatingRowStyle-BorderColor="#777d84">
    ...
    <asp:GridView ID="grdNets" runat="server" OnSorting="grdNets_Sorting"
    ...
    <h3 style="color:grey">Quarter Averages</h3>
    <asp:Button class="btn btn-primary active" ID="Button1" runat="server" Text="1st" OnClick="Button1_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="Button2" runat="server" Text="2nd" OnClick="Button2_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="Button3" runat="server" Text="3rd" OnClick="Button3_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    <asp:Button class="btn btn-primary active" ID="Button4" runat="server" Text="4th" OnClick="Button4_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    ...
    <br />
    <h3 style="color:grey">Quarter Game Logs</h3>
<div style="overflow-y: scroll;height: 200px; width:820px">
    ...
    <asp:Button class="btn btn-primary active" ID="btnPlayerGames" runat="server" Text="Retrieve" OnClick="BtnPlayerGames_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
    ...
    <asp:Button class="btn btn-primary active" ID="btnPlayerWins" runat="server" Text="Retrieve" OnClick="BtnPlayerWins_Click" BackColor="#777d84" ForeColor="White" BorderColor="#777d84"/>
