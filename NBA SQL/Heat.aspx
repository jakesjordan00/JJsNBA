<%@ Page MaintainScrollPositionOnPostback="true" Title="Heat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Heat.aspx.cs" Inherits="NBA_SQL.Heat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<div class="body_content">
    <style>
        body {background-color: Black}
    </style>
    <h1 style="color:#98002e"><asp:Image ID="Image1" Width="100px" Height="100px" runat="server" src="heat-logo.png"/>(MIA)Miami Heat</h1>
<%-- TO BE COPIED TO ALL OTHER TEAMS --%>
    <asp:GridView ID="grdTeam" runat="server" DataKeyNames="nickname" CssClass="RosterTable"  Width="1300px"  
     RowStyle-BackColor="#98002e"  RowStyle-ForeColor="White" OnRowDataBound="grdTeam_RowDataBound" 
     HeaderStyle-ForeColor="White" BorderColor="#98002e" HeaderStyle-BorderColor="Black" AlternatingRowStyle-BorderColor="#98002e">
    </asp:GridView>
   <br />
    <asp:Button class="btn btn-primary active" ID="btnPG" runat="server" Text="Per Game Statistics" OnClick="BtnPG_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="btnW" runat="server" Text="Per Game in Win" OnClick="btnW_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="btnSeason" runat="server" Text="Season Statistics" OnClick="BtnSeason_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="btnPM" runat="server" Text="Per Minute Statistics" OnClick="BtnPM_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:GridView ID="grdHeatPerMin" runat="server" DataKeyNames="Roster" AllowSorting="true" CssClass="RosterTable"  Width="1300px" Height="350px" OnSorting="grdHeatPerMin_Sorting" 
                  AlternatingRowStyle-BackColor="Black" RowStyle-BackColor="#98002e" RowStyle-ForeColor="White" AlternatingRowStyle-ForeColor="White" HeaderStyle-ForeColor="White"
                                                                                                                                                 HeaderStyle-BorderColor="Black"
                                                                                                                                                 RowStyle-BorderColor="#98002e"                                                                                                                                         
                                                                                                                                                 AlternatingRowStyle-BorderColor="Black">
    </asp:GridView>

    <asp:GridView ID="grdHeatSeason" runat="server" DataKeyNames="Roster" AllowSorting="true" CssClass="RosterTable"  Width="1300px" Height="350px" OnSorting="grdHeatSeason_Sorting"
                  AlternatingRowStyle-BackColor="Black" RowStyle-BackColor="#98002e" RowStyle-ForeColor="White" AlternatingRowStyle-ForeColor="White" HeaderStyle-ForeColor="White"
                                                                                                                                                 HeaderStyle-BorderColor="Black"
                                                                                                                                                 RowStyle-BorderColor="#98002e"                                                                                                                                         
                                                                                                                                                 AlternatingRowStyle-BorderColor="Black">
        ...
        <asp:GridView ID="grdW" runat="server"         DataKeyNames="Player"               OnRowDataBound="grdW_RowDataBound"  Width="1300px" OnSorting="grdW_Sorting" AllowSorting="true"
                  ...
                  RowStyle-BackColor="#98002e"          AlternatingRowStyle-BackColor="#000000"     HeaderStyle-BorderColor="#000000"             
                  RowStyle-BorderColor="#98002e"        AlternatingRowStyle-BorderColor="#000000" >

    </asp:GridView>
    <asp:GridView ID="grdHeat" runat="server" OnSorting="grdHeat_Sorting"
    ...
    <h3 style="color:#98002e">Quarter Averages</h3>
    <asp:Button class="btn btn-primary active" ID="Button1" runat="server" Text="1st" OnClick="Button1_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="Button2" runat="server" Text="2nd" OnClick="Button2_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="Button3" runat="server" Text="3rd" OnClick="Button3_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    <asp:Button class="btn btn-primary active" ID="Button4" runat="server" Text="4th" OnClick="Button4_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    ...
    <br />
    <h3 style="color:#98002e">Quarter Game Logs</h3>
<div style="overflow-y: scroll;height: 200px; width:820px">
    ...
    <asp:Button class="btn btn-primary active" ID="btnPlayerGames" runat="server" Text="Retrieve" OnClick="BtnPlayerGames_Click" BackColor="#98002e"  ForeColor="White" BorderColor="#98002e"/>
    ...
    <asp:Button class="btn btn-primary active" ID="btnPlayerWins" runat="server" Text="Retrieve" OnClick="BtnPlayerWins_Click" BackColor="#98002e" ForeColor="White" BorderColor="#98002e"/>
