...
namespace NBA_SQL
{
    public partial class Jazz : System.Web.UI.Page
    {
        ...
        protected void btnW_Click(object sender, EventArgs e)
        {
            ...
            grdJazz.Visible = false;
            grdJazzSeason.Visible = false;
            grdJazzPerMin.Visible = false;
            grdW.Visible = true;
        }
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdJazzSeason.DataSource = dataT;
                            grdJazzSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdJazzPerMin.DataSource = dataT;
                            grdJazzPerMin.DataBind();
        ...
        {
            grdJazz.Visible = true;
            grdJazzSeason.Visible = false; grdW.Visible = false;
            grdJazzPerMin.Visible = false;
        }
        ...
        {
            grdJazz.Visible = false;
            grdJazzSeason.Visible = true;
            grdJazzPerMin.Visible = false; grdW.Visible = false;
        }
        protected void BtnPM_Click(object sender, EventArgs e)
        {
            grdJazz.Visible = false;
            grdJazzSeason.Visible = false;
            grdJazzPerMin.Visible = true; grdW.Visible = false;
        }
        ...
        protected void grdJazz_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
        ...
        protected void grdJazzSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdJazzSeason.DataSource = sortedView;
                            grdJazzSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdJazzPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdJazzPerMin.DataSource = sortedView;
                            grdJazzPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("Jazz"))
                {
                    querySearch.Connection = sqlConnect;
