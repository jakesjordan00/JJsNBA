...
namespace NBA_SQL
{
    public partial class _76ers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindGrid();
                grdSixers.Visible = true;
                grdSixersSeason.Visible = false;
                grdSixersPerMin.Visible = false;
                grdW.Visible = false;
                PopulateRoster();
                GridView1.Visible = false;
                GridView2.Visible = false;
            ...
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdSixersSeason.DataSource = dataT;
                            grdSixersSeason.DataBind();
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        {
                            sDataSearch.Fill(dataT);
                            grdSixersPerMin.DataSource = dataT;
                            grdSixersPerMin.DataBind();
                            ...
                            foreach (GridViewRow row in grdPlayerGames.Rows)
                            {
                                ...
                                if (matchup == blazers)
                                {
                                    ...
                                    if (i % 2 == 0) //row
                                    {
                                        ...
                                        row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                        row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#c4ced4;\" >" + teamLink1 + "</a>";
                                    }
                                    else //alternating row
                                    {
                                        ...
                                        row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#002b5c; \" >" + teamLink1 + "</a>";
                                    }
                                }
                                else
                                {
                                    if (i % 2 == 0)
                                    {
                                        ...
                                        row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex);
                                        row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                        row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#c4ced4; \" >" + team1 + "</a>";
                                    ...
                                    else
                                    {
                                        ...
                                        row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                        row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(hex);
                                        row.Cells[0].Text = "<a href=\"/" + team1 + "\" style=\"color:#002b5c; \" >" + team1 + "</a>";
                                    }
                                }
                            }
                        }
                                ...
                                foreach (GridViewRow row in grdPlayerWins.Rows)
                                {
                                    ...
                                    if (team == blazers)
                                    {
                                        ...
                                        if (i % 2 == 0)
                                        {
                                            ...
                                            row.Cells[0].BorderColor = System.Drawing.ColorTranslator.FromHtml(hex);
                                            row.Cells[0].ForeColor = System.Drawing.ColorTranslator.FromHtml(hex1);
                                            row.Cells[0].Text = "<a href=\"/" + teamLink + "\" style=\"color:#c4ced4;\" >" + team1 + "</a>";
                                        }
                                        else
                                        {
                                            row.Cells[0].BackColor = System.Drawing.ColorTranslator.FromHtml(hex1);
        ...
        {
            grdSixers.Visible = false;
            grdSixersSeason.Visible = true;
            grdSixersPerMin.Visible = false;
            grdW.Visible = false;
        }
        ...
        protected void grdSixers_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("roster"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            grdSixers.DataSource = sortedView;
                            grdSixers.DataBind();
                        }
                    }
                }
        ...
        protected void grdSixersSeason_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterseason"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdSixersSeason.DataSource = sortedView;
                            grdSixersSeason.DataBind();
                        }
                    }
                }
        ...
        protected void grdSixersPerMin_Sorting(object sender, GridViewSortEventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nba1_18;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                ...
                using (SqlCommand querySearch = new SqlCommand("rosterperminute"))
                {
                    ...
                    using (SqlDataAdapter sDataSearch = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dataT = new DataTable())
                        {
                            ...
                            DataView sortedView = new DataView(dataT);
                            sortedView.Sort = e.SortExpression + " " + SortDir;
                            grdSixersPerMin.DataSource = sortedView;
                            grdSixersPerMin.DataBind();
                        }
                    }
                }
        ...
        protected void PopulateRoster()
        {
            ...
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("76ers"))
                {
                    querySearch.Connection = sqlConnect;
